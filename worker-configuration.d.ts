/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 422b95f7746a9dae004e9752bf0958a3)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	API_KEY: string;
	HUB: DurableObjectNamespace<import("./src/index").NotificationHub>;
	TENANTS: DurableObjectNamespace<import("./src/index").TenantRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NotificationHub" | "TenantRegistry";
	}
